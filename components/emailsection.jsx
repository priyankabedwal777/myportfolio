...
const emailsection = () => {
  ...
  return (
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
        ...
        <p className='text-[#ADB7BE] mb-4 max-w-md '>I'm currently whgfdwed looking for a new opportunity, my inbox is always Whether you have a question or just want to say hi, I'll try my best to get back to you!</p>
